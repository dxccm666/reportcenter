...
CREATE TABLE REPORTS (
	...
	ISSCREENREPORT NUMBER(1) DEFAULT 0 NOT NULL,
	SCREENNAME VARCHAR2(1000),
	CAMPUSID VARCHAR2(10),
	ISALLCAMPUS NUMBER(1) DEFAULT 0 NOT NULL,
	ISACTIVE NUMBER(1) DEFAULT 1 NOT NULL,
	FILENAME VARCHAR2(300),
	REQUESTED TIMESTAMP,
	REQUESTEDBY VARCHAR2(10), /* SHOULD THIS BE PERSONID IN PROJEX 4 */
	...
	REGISTEREDBY VARCHAR2(10), /* THIS SHOULD BE USERID IN PROJEX 4 */
	...
	PRIMARY KEY (ID),
	CONSTRAINT REPORTS_U UNIQUE (SCREENNAME, REPORTNAME),
...
create index reports_idx10 on reports (isscreenreport, screenname);
...
CREATE INDEX REPORTS_17 ON REPORTS (SCREENNAME, ISACTIVE, CAMPUSID, ISALLCAMPUS, ID);
