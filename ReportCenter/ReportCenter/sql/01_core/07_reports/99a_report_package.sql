...
FUNCTION REPORT (VID IN VARCHAR2, VROWSTAMP IN VARCHAR2, VREPORTNAME IN VARCHAR2, VDESCRIPTION IN VARCHAR2, VHELPTEXT IN VARCHAR2, VISSCREENREPORT IN NUMBER, VSCREENNAME IN VARCHAR2, VCAMPUSID IN VARCHAR2, 
	VISALLCAMPUS IN NUMBER, VISACTIVE IN NUMBER, VFILENAME IN VARCHAR2, VREQUESTED IN TIMESTAMP, 
	VREQUESTEDBY IN VARCHAR2, VREASON IN VARCHAR2, VREGISTERED IN TIMESTAMP, VREGISTEREDBY IN VARCHAR2, VCATEGORY IN VARCHAR2) RETURN VARCHAR2;
	
PROCEDURE REPORT (VREPORTNAME IN VARCHAR2, VDESCRIPTION IN VARCHAR2, VHELPTEXT IN VARCHAR2, VISSCREENREPORT IN NUMBER, VSCREENNAME IN VARCHAR2, VCAMPUSID IN VARCHAR2, VISALLCAMPUS IN NUMBER, VISACTIVE IN NUMBER, VFILENAME IN VARCHAR2, VREQUESTED IN TIMESTAMP, VREQUESTEDBY IN VARCHAR2, 
	VREASON IN VARCHAR2, VREGISTERED IN TIMESTAMP, VREGISTEREDBY IN VARCHAR2, VCATEGORY IN VARCHAR2); 
...
PROCEDURE REPORTPARAMETER (VREPORTNAME IN VARCHAR2, VPARAMETERNUMBER IN NUMBER, VPARAMETER IN VARCHAR2, 
	VPARAMETERTYPE IN VARCHAR2, VLISTNAME IN VARCHAR2);
