...
CREATE TABLE USERS (
	...
	INVITATIONCODE VARCHAR2(20),
	INVITATIONEMAIL VARCHAR2(200),
	INVITED TIMESTAMP,
	INVITATIONEMAILED TIMESTAMP,
	INITIALIZED NUMBER(1) DEFAULT 0 NOT NULL,
	PASSWORD VARCHAR2(64),
	PASSWORDEXPIRATION TIMESTAMP,
	FORCEEXPIRATION NUMBER(1) DEFAULT 0 NOT NULL,
	USERTYPE VARCHAR2(20) DEFAULT 'EXTERNAL' NOT NULL,
	REGISTRATIONMETHOD VARCHAR2(20) DEFAULT 'INVITED' NOT NULL,
	ISACTIVE NUMBER(1) DEFAULT 1 NOT NULL,
	SECRETKEY VARCHAR2(10),
	SALT VARCHAR2(20),
	EMAILSCHEDULE VARCHAR2(10),
	NOTIFYBYEMAIL NUMBER(1) DEFAULT 0 NOT NULL,
	VERIFIER VARCHAR2(50),
	PRIMARY KEY (ID),
