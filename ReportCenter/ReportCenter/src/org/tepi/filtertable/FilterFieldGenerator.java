...
public class FilterFieldGenerator implements Serializable {
    ...
    protected final Map<Object, Filter> filters = new HashMap<Object, Container.Filter>();
    protected final Map<AbstractField<?>, Object> customFields = new HashMap<AbstractField<?>, Object>();
    protected final Map<TextField, Object> texts = new HashMap<TextField, Object>();
    protected final Map<ComboBox, Object> enums = new HashMap<ComboBox, Object>();
    protected final Map<ComboBox, Object> booleans = new HashMap<ComboBox, Object>();
    protected final Map<DateFilterPopup, Object> dates = new HashMap<DateFilterPopup, Object>();
    protected final Map<NumberFilterPopup, Object> numbers = new HashMap<NumberFilterPopup, Object>();

    protected And lastOnDemandFilter;

    /* ValueChangeListener for filter components */
    protected final ValueChangeListener listener = initializeListener();

    protected boolean runFiltersOnDemand;
    
    public FilterFieldGenerator() {
    	
    }

    public FilterFieldGenerator(IFilterTable owner) {
        this.owner = owner;
    }
