...
public class NavigatorOpenerButton2 extends Button {
	...
	protected PopupExtension popupExtension;

	public NavigatorOpenerButton2() {
		setCaption("open in ...");
		setDescription("Open selected item in a screen");
		init();
	}

	public NavigatorOpenerButton2(String caption) {
		super(caption);
		init();
	}
	...
	private void init() {
		...
		popupExtension = PopupExtension.extend(this);
		...
		setIcon(new ThemeResource("icons/chalkwork/basic/folder_open_16x16.png"));
		...
		content.addStyleName("buttonopener2");
		popupExtension.setContent(content);
